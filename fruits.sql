...
-- Дамп данных таблицы fruit.categories: 29 rows
...
INSERT IGNORE INTO `categories` (`category_id`, `title`, `description`, `status`, `parent_id`, `sort_order`, `in_main_menu`, `class`, `first_line`, `seo_url`) VALUES
	...
	(28, 'Черный чай', NULL, 1, 9, 0, 0, NULL, 0, NULL),
	(29, 'Травяной чай', NULL, 1, 9, 0, 0, NULL, 0, NULL),
	(30, 'Зеленый чай', NULL, 1, 9, 0, 0, NULL, 0, NULL),
	(31, 'Пицца и выпечка', NULL, 0, 20, 0, 0, NULL, 0, NULL);
...
-- Дамп данных таблицы fruit.orders: 21 rows
...
INSERT IGNORE INTO `orders` (`order_id`, `account_id`, `shipping_address`, `shipping_metro`, `shipping_method`, `shipping_method_id`, `shipping_price`, `shipping_date`, `courier_id`, `used_bonus`, `create_date`, `status`) VALUES
	...
	(17, 7, '555', 'Авиа', 'Обычная доставка - МO (до 25 км от мкада)', 2, 350, '', 2, 0, 1508544000, 4),
	...
	(21, 7, '555', 'Авиа', 'Обычная доставка - МO (до 25 км от мкада)', 2, 0, '', 0, 0, 1508751648, 1);
...
-- Дамп данных таблицы fruit.order_inners: 27 rows
...
INSERT IGNORE INTO `products` (`product_id`, `title`, `brand`, `quantity`, `type`, `cost`, `percent`, `price`, `image`, `description`, `country`, `special`, `special_begin`, `special_end`, `subtract`, `status`, `condition_id`, `eko`, `farm`, `weight`, `composition`, `provider`, `pack`) VALUES
	...
	(28, 'Мясо 1', 'Valio', 100, 'кг', 20, 50, 0, 'yabloko_7.jpg', 'Сочное мясо', 'Россия', 90, '2017-09-29', '2017-11-30', 0, 1, 1, 1, 0, '100', 'мясо', NULL, ''),
	...
	(40, 'Дянь Хун', 'CHEF TEA', 100, 'г', 100, 30, NULL, '2017-09-3015-59-24_16-03-22.JPG', 'Красный китайский чай с типсами. Послевкусие чернослива', 'Россия', 10, '0000-00-00', '0000-00-00', 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(41, 'Цейлон Pekoe', 'CHEF TEA', 100, 'г', 100, 30, NULL, '2017-09-3015-59-19_16-05-27.JPG', 'Цейлонский Pekoe чай с ароматом пряных трав', 'Россия', 10, '0000-00-00', '0000-00-00', 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(42, 'Цейлон ', 'CHEF TEA', 100, 'г', 100, 30, NULL, '2017-09-3015-59-15_16-06-18.JPG', 'Чай из молодых листочков с цветочными нотами', 'Россия', 10, '0000-00-00', '0000-00-00', 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(43, 'Индийский Pekoe', 'CHEF TEA', 100, 'г', 100, 30, NULL, '2017-09-3015-59-00_16-07-30.JPG', 'Чай стандарта Pekoe. Юг Индии', 'Россия', 10, '0000-00-00', '0000-00-00', 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(44, 'Ассам Pekoe', 'CHEF TEA', 100, 'г', 100, 30, NULL, '2017-09-3015-58-53_16-08-03.JPG', 'Чай стандарта Pekoe с мягким медовым послевкусием', 'Россия', NULL, NULL, NULL, 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(45, 'Ассам', 'CHEF TEA', 100, 'г', 100, 30, NULL, '2017-09-3015-58-47_16-09-39.JPG', 'Индийский чай с мягким медовым послевкусием', 'Россия', NULL, NULL, NULL, 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(46, 'Ассам моколбари', 'CHEF TEA', 100, 'г', 100, 30, NULL, '2017-09-3015-58-34_16-10-14.JPG', 'Индийский чай TGFOP с повышенным содержанием типсов', 'Россия', NULL, NULL, NULL, 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(47, 'Дарджилин', 'CHEF TEA', 100, 'г', 100, 30, NULL, '2017-09-3015-58-29_16-10-51.JPG', 'Весенний чай с гор Гималаев с мускатными нотками', 'Россия', NULL, NULL, NULL, 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(48, 'Английский завтрак', 'CHEF TEA', 100, 'г', 100, 30, NULL, '2017-09-3015-58-26_16-11-30.JPG', 'Смесь Дарджилинг и Ассам с цветочно-мускатным оттенком', 'Россия', NULL, NULL, NULL, 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(49, 'Лист смородины', 'CHEF TEA', 100, 'г', 100, 30, NULL, '2017-09-3015-55-06_16-12-00.JPG', 'Лист черной смородины 5-7 мм.', 'Россия', NULL, NULL, NULL, 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(50, 'Трава чабрец', 'CHEF TEA', 100, 'г', 100, 30, NULL, '2017-09-3015-54-58_16-12-34.JPG', 'Содержит витаминамы В и С. Антисептический эффект.', 'Россия', NULL, NULL, NULL, 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(51, 'Ромашка', 'CHEF TEA', 100, 'г', 100, 30, NULL, '2017-09-3015-54-47_16-13-22.JPG', 'Содержит витаминамы В и С. Антисептический эффект.', 'Россия', NULL, NULL, NULL, 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(52, 'MIX & BAKE с шоколадом', 'MIX & BAKE', 10, 'г', 100, 30, 150, '2017-09-3015-54-34_16-14-08.JPG', 'MIX & BAKE с шоколадом. Смесь для выпечки.', 'Германия', NULL, NULL, NULL, 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(53, 'MIX & BAKE M&Ms', 'MIX & BAKE', 10, 'г', 100, 30, 150, '2017-09-3015-54-29_16-15-01.JPG', 'MIX & BAKE шоколадный M&Ms. Смесь для выпечки.', 'Германия', NULL, NULL, NULL, 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(54, 'MIX & BAKE с матча', 'MIX & BAKE', 10, 'г', 100, 30, 150, '2017-09-3015-54-08_16-15-31.JPG', 'MIX & BAKE с чаем Матча. Смесь для выпечки.', 'Германия', NULL, NULL, NULL, 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(55, 'MIX & BAKE ягоды злаки', 'MIX & BAKE', 10, 'г', 100, 30, 150, '2017-09-3015-53-59_16-16-05.JPG', 'MIX & BAKE ягоды и злаки. Смесь для выпечки.', 'Германия', NULL, NULL, NULL, 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(56, 'Малина с мятой', 'CHEF TEA', 100, 'г', 100, 30, NULL, '2017-09-3015-53-32_16-57-06.JPG', 'Хинабуш, ройбуш зеленый, мята, клубника, лепестки розы', 'Россия', NULL, NULL, NULL, 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(57, 'Мате', 'CHEF TEA', 100, 'г', 100, 30, NULL, '2017-09-3015-53-24_16-58-23.JPG', 'Зеленый мате из листьев падуба парагвайского. Аргентина', 'Россия', NULL, NULL, NULL, 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(58, 'Русские традиции', 'CHEF TEA', 100, 'г', 100, 30, NULL, '2017-09-3015-53-18_17-02-58.JPG', 'Чабрец, ромашка, мелиса лимонная, лист смородины', 'Россия', NULL, NULL, NULL, 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(59, 'Имбирный лимонник', 'CHEF TEA', 100, 'г', 100, 30, NULL, '2017-09-3015-52-55_17-03-35.JPG', 'Лимонная трава (lemongrass), цедра лимона, имбирь', 'Россия', NULL, NULL, NULL, 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(60, 'Успокаивающий', 'CHEF TEA', 100, 'г', 100, 30, NULL, '2017-09-3015-52-50_17-04-07.JPG', 'Мелисса, гибискус, вереск, мята, яблоки, фенхель', 'Россия', NULL, NULL, NULL, 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(61, 'Зеленый чай матча', 'CHEF TEA', 100, 'г', 100, 30, NULL, '2017-09-3015-52-16_17-04-39.JPG', 'Зеленый китайский чай по японской технологии', 'Россия', NULL, NULL, NULL, 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(62, 'Лаванда', 'CHEF TEA', 100, 'г', 100, 30, NULL, '2017-09-3015-52-10_17-05-15.JPG', 'Цветки лаванды. Применяется как добавка к чаю', 'Россия', NULL, NULL, NULL, 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(63, 'Лимонная трава ', 'CHEF TEA', 100, 'г', 100, 30, NULL, '2017-09-3015-52-04_17-24-14.JPG', 'Лимонная трава (lemongrass) с тонизирующим эффектом', 'Россия', NULL, NULL, NULL, 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(64, 'Вечерний', 'CHEF TEA', 100, 'г', 100, 30, NULL, '2017-09-3015-51-56_17-37-19.JPG', 'Мелисса, мята, ромашка, лаванда, василек, шалфей', 'Россия', NULL, NULL, NULL, 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(65, 'Чай с мятой', 'CHEF TEA', 100, 'г', 100, 30, NULL, '2017-09-3015-51-20_17-37-50.JPG', 'Индийский черный чай, мята, василек. Успокаивающий', 'Россия', NULL, NULL, NULL, 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(66, 'Чай с чабрецом', 'CHEF TEA', 100, 'г', 100, 30, NULL, '2017-09-3015-51-10_17-39-00.JPG', 'Индийский черный чай с чабрецом от простуды', 'Россия', NULL, NULL, NULL, 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(67, 'Восточный имбирь', 'CHEF TEA', 100, 'г', 100, 30, NULL, '2017-09-3015-51-01_17-39-49.JPG', 'Индийский черный чай с кусочкамии имбиря', 'Россия', NULL, NULL, NULL, 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(68, 'Масала', 'CHEF TEA', 100, 'г', 100, 30, NULL, '2017-09-3015-50-57_17-40-19.JPG', 'Индийский чай, корица, анис, фенхель, имбирь, перец', 'Россия', NULL, NULL, NULL, 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(69, 'Сладкий цитрус', 'CHEF TEA', 100, 'г', 100, 30, NULL, '2017-09-3015-50-21_17-40-56.JPG', 'Индийский чай, цедра лимона и апельсина, сафлор', 'Россия', NULL, NULL, NULL, 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики'),
	(70, 'Божественный', 'CHEF TEA', 100, 'г', 100, 30, NULL, '2017-09-3015-50-02_17-42-33.JPG', 'Индийский чай, василек, лимонная трава, цедра апельсина', 'Россия', NULL, NULL, NULL, 1, 1, 1, 1, 0, NULL, 'чай например', 'TC-1-18-012', 'пакетики');
