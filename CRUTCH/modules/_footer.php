		<footer>
			<div class="content_helper">
				...
				<div class="f_block">
					...
					<div class="f_delivery_text">
						Минимальный заказ 1000 руб. Стоимость 
						<br>обычной доставки 199 руб., экспресс - 399 руб.
					</div>
					<div><a href="/delivery" class="f_block_link f_delivery_link">подробно</a></div>
				</div>
				<div class="f_block">
					<div class="f_block_header">Программы <br>лояльности</div>
					<div><a href="/" class="f_block_link">Преимущества первого заказа</a></div>
					<div><a href="/" class="f_block_link">Преимущества второго заказа</a></div>
