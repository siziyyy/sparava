...
<html class="no-js" lang="">
    ...
    <body>
        <section class="admin">
            <table class="orders orders_list_tbl">
                ...
                <tr class="table_content">
                    <td><a class="open_order">543435</a></td>
                    <td>
                        сегодня
                        <br>
                    ...
                    <td>Перово</td>
                    <td class="tal">
                        Адмирала Ушакова 152 к 1 кв 145 др 1 
                        под 4 этаж 14 дом 145вка
                    </td>
                    <td>14</td>
                    <td>9750</td>
                </tr>
                <tr class="table_content">
                    <td><a class="open_order">25432</a></td>
                    <td>
                        сегодня
                        <br>
                        <span class="dev_t">18:00 - 19:00</span>
            ...
            <div class="well_done_i_am_on_my_way">
                <div class="wdimomw_name">Иванов Артем</div>
                <div class="wdimomw_sign">
                    все заказы проверены и приняты мною
                    <span class="sign_place">_______________________________</span>
                </div>
                <div class="wdimomw_date">13.08.2016</div>
            </div>
        </section>
