    ...
    <body>
        ...
        <section class="admin">
            ...
            <div class="admin_menu">
                ...
                <a href="index3.php" class="admin_menu_item active_admin_menu_item">Готовы к отправке</a>
            ...
            <table class="orders">
                <tr class="table_header">
                    <td>
                        <span class="select_it select_all">
                            <input type="checkbox">
                        </span>
                        №
                    </td>
                ...
                <tr class="table_content">
                    ...
                    <td>
                        50
                        <span class="to_cour_it to_cour_all"></span>
                    </td>
                </tr>
                <tr class="sep">
                    <td>вчера</td>
            ...
            <div class="orders_buttons_cour">
                <a target="_blank" href="orders_list.php" class="orders_button orders_cour_print">печать путевого листа</a>
                <div class="orders_button orders_to_cour">
                    <div class="to_cour_sel">
                        <a class="to_cour_modal_link">Максим Шевченко</a>
                        <a class="to_cour_modal_link">Иван Ургант</a>
                        <a class="to_cour_modal_link">Гарик Мартиросян</a>
                    </div>
                    передать курьеру
                </div>
            </div>
            <div class="to_cour_sel_mask"></div>
        </section>
