		...
		.content {
			margin-top: 50px;
                ...
                <div class="mobile_blog_header">
                	<a href="/providers_blogs" class="cyvguhbijnokml cyvguhbijnokml_cur">Информация о поставщиках</a>
                	<a href="/blogs" class="cyvguhbijnokml">Вкусный блог</a>
                	<div class="clear"></div>
                </div>
        <section class="content">
            <div class="content_helper">
					...
					<div class="blog_content">
						...
						<div class="blog_item">
							<a href="/blogs/<?php echo $large_post['blog_id']; ?>">
								<div class="blog_img" style="background: url('/assets/img/blogs/providers/1.jpg');"></div>
							</a>
							<div class="clog_date"><?php echo date('d.m',$large_post['create_date']); ?></div>
						...
						<?php foreach($blogs_for_date as $blog) { ?>
							<div class="blog_item">
								<a href="/blogs/<?php echo $blog['blog_id']; ?>">
									<div class="blog_img">
										<img src="/assets/img/blogs/providers/1.jpg" class="blog_img_img">
									</div>
								</a>
								<div class="clog_date"><?php echo date('d.m',$blog['create_date']); ?></div>
