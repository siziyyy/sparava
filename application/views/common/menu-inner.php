                ...
                <?php if(!$is_parent_category) { ?>
                    <div class="c_new_menu_filters filters_holder">						
						...
						<div class="cool_select_pack fl_l" data-type="price">
					   	...
					   	<form id="download_price_list_form" method="POST">
            				<input type="hidden" value="1" name="download_price_list" />
            			</form> 
						
						<div class="cool_select_goods_count fl_r"><a href="#" class="doanload_price_list">скачать прайс-лист</a>
