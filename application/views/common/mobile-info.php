        ...
        <div class="aside_mobile_menu aside_mobile_menu_main">
            ...
            <div class="aside_mobile_menu_new_content_first">
                ...
                <div class="aside_mobile_menu_new_content_first_block">
                    ...
                    <div class="aside_mobile_menu_new_content_first_link mobinfo" data-target="block-delivery">Доставка<span class="aside_mobile_menu_new_content_first_arrow new_sprite"></span></div>
                    <div class="aside_mobile_menu_new_content_first_link mobinfo" data-target="block-quality">Гарантия качества<span class="aside_mobile_menu_new_content_first_arrow new_sprite"></span></div>
                    <div class="aside_mobile_menu_new_content_first_link mobinfo" data-target="block-return">Прием заказа, обмен, возврат<span class="aside_mobile_menu_new_content_first_arrow new_sprite"></span></div>
                    <div class="aside_mobile_menu_new_content_first_link mobinfo" data-target="block-conditions">Условия доставки<span class="aside_mobile_menu_new_content_first_arrow new_sprite"></span></div>
                </div>
                <div class="aside_mobile_menu_new_content_first_block">
                    <div class="aside_mobile_menu_new_content_first_header">Программы  лояльности</div>
                    <div class="aside_mobile_menu_new_content_first_link mobinfo" data-target="block-first">Преимущество первого заказа<span class="aside_mobile_menu_new_content_first_arrow new_sprite"></span></div>
                    <div class="aside_mobile_menu_new_content_first_link mobinfo" data-target="block-bonus">Бонусная система<span class="aside_mobile_menu_new_content_first_arrow new_sprite"></span></div>
                </div>
                <div class="aside_mobile_menu_new_content_first_block">
                    <div class="aside_mobile_menu_new_content_first_header">Мы и о нас!</div>
                    <div class="aside_mobile_menu_new_content_first_link mobinfo" data-target="block-about">О нас<span class="aside_mobile_menu_new_content_first_arrow new_sprite"></span></div>
                    <div class="aside_mobile_menu_new_content_first_link mobinfo" data-target="block-testimonials">Отзывы о нас<span class="aside_mobile_menu_new_content_first_arrow new_sprite"></span></div>
                    <div class="aside_mobile_menu_new_content_first_link mobinfo" data-target="block-contacts">Контакты<span class="aside_mobile_menu_new_content_first_arrow new_sprite"></span></div>
                </div>
                <div class="aside_mobile_menu_new_content_first_block">
                    <div class="aside_mobile_menu_new_content_first_header">Сотрудничество</div>
                    <div class="aside_mobile_menu_new_content_first_link mobinfo" data-target="block-providers">Поставщики<span class="aside_mobile_menu_new_content_first_arrow new_sprite"></span></div>
                    <div class="aside_mobile_menu_new_content_first_link mobinfo" data-target="block-bloggers">Блогеры<span class="aside_mobile_menu_new_content_first_arrow new_sprite"></span></div>
                    <div class="aside_mobile_menu_new_content_first_link mobinfo" data-target="block-work">Работа в компании<span class="aside_mobile_menu_new_content_first_arrow new_sprite"></span></div>
                </div>
                <div class="aside_mobile_menu_new_content_first_block">
                    <div class="aside_mobile_menu_new_content_first_header">Что не так?</div>
                    <div class="aside_mobile_menu_new_content_first_link mobinfo" data-target="block-feedback">Претензии<span class="aside_mobile_menu_new_content_first_arrow new_sprite"></span></div>
                    <div class="aside_mobile_menu_new_content_first_link mobinfo" data-target="block-offers">Предложения<span class="aside_mobile_menu_new_content_first_arrow new_sprite"></span></div>
                </div>
            </div>
        </div>
        ...
        <div class="aside_mobile_menu aside_mobile_menu_inner">
            ...
            <div class="aside_mobile_menu_new_content_first">
                ...
                <div class="aside_mobile_menu_new_content_second_block" id="block-contacts">
                ...
                <div class="aside_mobile_menu_new_content_second_block" id="block-delivery">
                ...
                <div class="aside_mobile_menu_new_content_second_block" id="block-quality">
                ...
                <div class="aside_mobile_menu_new_content_second_block" id="block-first">
                    ...
                    <div class="aside_mobile_menu_new_content_second_content">
                        ...
                        <div class="aside_mobile_menu_new_content_second_text_recs">
                            <?php foreach($related_products as $product) { ?>
                                <a href="/product/<?php echo $product['product_id'] ?>" class="aside_mobile_menu_new_content_second_text_recs_linkbl">
                ...
                <div class="aside_mobile_menu_new_content_second_block" id="block-bonus">
                ...
                <div class="aside_mobile_menu_new_content_second_block" id="block-providers">
                ...
                <div class="aside_mobile_menu_new_content_second_block" id="block-bloggers">
                ...
                <div class="aside_mobile_menu_new_content_second_block" id="block-work">
                ...
                <div class="aside_mobile_menu_new_content_second_block" id="block-feedback">
                ...
                <div class="aside_mobile_menu_new_content_second_block" id="block-offers">
                ...
                <div class="aside_mobile_menu_new_content_second_block" id="block-testimonials">
                ...
                <div class="aside_mobile_menu_new_content_second_block" id="block-about">
                ...
                <div class="aside_mobile_menu_new_content_second_block" id="block-return">
