...
<div class="add_comment">
    <div class="comment_photo fl_l" style="background: #009933;"><?php echo mb_strtoupper(substr($account['name'], 0, 1),'UTF-8') ?></div>
...
<?php if(isset($comments)) { ?>    
    <?php foreach($comments as $comment) { ?>  
        <div class="comment">
            <div class="comment_photo fl_l" style="background: #4994D1;"><?php echo mb_strtoupper(substr($comment['account']['name'], 0, 1),'UTF-8') ?></div>
