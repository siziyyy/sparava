<?php $this->load->view('mobile/common/header',$header);?>
    <div class="info_page content">
        ...
        <div class="info_page_body">
            <div class="info_page_body_header">Сотрудничество и работа</div>
            <a href="/information/caterer" class="info_page_body_link">Поставщики</a>
            <a href="/information/vacancy" class="info_page_body_link">Работа</a>
			<a href="/information/bloger" class="info_page_body_link">Блогерам</a>
        </div>
    </div>
