<?php $this->load->view('mobile/common/header',$header);?>
    ...
    <div class="content">
        <form class="callpageform" action="">
            <input type="hidden" class="callme_input feedback_subject" value="<?php echo $subject ?>">
            <label class="callpageform_label">
                <span class="callpageform_label_text">Имя</span>
                <input type="text" class="callpageform_input feedback_name">
            </label>
            <label class="callpageform_label">
                <span class="callpageform_label_text">Телефон</span>
                <input type="phone" class="callpageform_input feedback_phone">
            </label>
            <label class="callpageform_label">
                <span class="callpageform_label_text">Почта</span>
                <input type="text" class="callpageform_input feedback_email">
            </label>
            <button class="callpageform_button send" data-type="feedback">отправить</button>
            <div class="feedback_success callme_label">Сообщение было отправлено</div>
        </form>
    </div>
