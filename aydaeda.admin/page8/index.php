...
<section class="hz_pack">
    ...
    <div class="hz_line hz_line2">
        <div class="hz_line_header">Место</div>
        <div class="hz_line_items clear">
            <div class="hz_line_item fl_l">Л</div>
            <div class="hz_line_item fl_l">ЛЦ</div>
            <div class="hz_line_item fl_l">ПЦ</div>
            <div class="hz_line_item fl_l">П</div>
        </div>
        <div class="hz_line_button">добавить</div>
        <input type="text" class="hz_line_input">
    </div>
