...
<header>
    ...
    <div class="buttons_to_sort_chtoli">
        <div class="this_is_button_to_sort_chtoli_header">ТЦ 1 10 - 25</div>
        <div class="this_is_button_to_sort_chtoli">на развес</div>
        <div class="this_is_button_to_sort_chtoli">упаковка</div>
        <div class="this_is_button_to_sort_chtoli">нет цены</div>
    </div>
</header>
<section class="choose_your_category_again">
    <? for ($i=0; $i < 11; $i++) { ?>
        <a href="/page5" class="aydaadmin_good">
