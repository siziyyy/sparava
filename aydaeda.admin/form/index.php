...
<section class="choose_your_category">
    <form action="" class="choose_your_category_form">
        <label class="choose_your_category_form_label">
            телефон
            <input type="phone" class="choose_your_category_form_input">
        </label>
        <label class="choose_your_category_form_label">
            лицо
            <input type="phone" class="choose_your_category_form_input">
        ...
        <label class="choose_your_category_form_label">
            комментарий
            <textarea type="phone" class="choose_your_category_form_input choose_your_category_form_textarea"></textarea>
        </label>
        <input type="submit" class="choose_your_category_form_button" value="добавить">
        <div class="choose_your_category_form_button">пропустить</div>
    </form>
</section>
